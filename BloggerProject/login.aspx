<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="BloggerProject.login" %>
                    ...
                    <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                        ...
                        <li class="nav-item d-none d-lg-block ml-lg-4">
                            <a href="./login.aspx" class="btn btn-neutral btn-icon">
                                ...
                                <span class="nav-link-inner--text" runat="server" id="logstatus">Log in</span>
                            </a>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="card-body px-lg-5 py-lg-5">
                                    ...
                                    <form role="form" runat="server">
                                        ...
                                        <div class="text-center">
                                            <asp:Button ID="Button1" runat="server" Text="Sign in"  class="btn btn-primary my-4" OnClick="Login"/>
